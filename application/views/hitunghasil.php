        ...
        <div id="printpa" style="margin-left: 1.5cm;margin-right: 1.5cm;">
            ...
            <table width="100%" >
                ...
                <tr>
                    ...
                    Berdasarkan hasil perhitungan yang dilakukan menggunakan Sistem Pendukung Keputusan (SPK) dengan Metode TOPSIS, didapatkan hasil ranking siswa berprestasi atas nama sebagai berikut :
                        <br><br>
                    </td>
                </tr>
                <tr>
